...
public class VariableExpression implements Expression {
	...
	/*
Rep Invariant:
-VariableExpression is never null
-Name of VariableExpression is immutable

Abstraction Function:
Represents a mutable variable denoted by an alphabetic string which can store a value.
 */
	 ...
	 * Requires: a value must be stored in the variable.
